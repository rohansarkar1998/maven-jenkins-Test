    ...
    <div class="az-header">
      <div class="container">
        <div class="az-header-left">
          <a href="index.html" class="az-logo"><span></span>RK Electronics</a>
          <a href="" id="azMenuShow" class="az-header-menu-icon d-lg-none"><span></span></a>
        </div><!-- az-header-left -->
        <div class="az-header-menu">
          <div class="az-header-menu-header">
            <a href="index.html" class="az-logo"><span></span> RK </a>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a href="Information.jsp" class="nav-link"><i class="typcn typcn-chart-bar-outline"></i> Informatics</a>
            </li>
        ...
        <div class="az-content-body">
          <div class="az-dashboard-one-title">
            <div>
              ...
              <p class="az-dashboard-text">Your web analytics dashboard is Ready.</p>
            </div>
